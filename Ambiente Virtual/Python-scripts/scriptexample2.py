...
# Piece of code to include site package of virtual environment in sys path first position

SCRIPT_DIRECTORY = os.path.dirname(os.path.abspath(__file__))
site_package_venv = os.path.join(SCRIPT_DIRECTORY, ".venv", "Lib", "site-packages")
sys.path.insert(0, site_package_venv)
